...
def main():
    ...
    add_parser.add_argument("--symbol", required=True, help="Stock symbol (e.g., AAPL).")
    add_parser.add_argument("--security", required=True, help="Company name (e.g., Apple Inc.).")
    add_parser.add_argument("--gics_sector", default="", help="GICS Sector (e.g., Technology).")
    add_parser.add_argument("--gics_industry", default="", help="GICS Industry (e.g., Consumer Electronics).")
    add_parser.add_argument("--country", default="", help="Country (e.g., USA).")
    add_parser.add_argument("--region", default="", help="Region (e.g., North America).")
