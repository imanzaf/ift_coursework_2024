...
def validate_esg_report(url: str, metadata: str, company_name: str, year: int) -> bool:
    """
    ...
    normalized_content = (url + " " + metadata).lower()  # Combine URL and metadata for validation
...
def is_valid_esg_report_from_url(pdf_url: str, company_name: str, year: int) -> bool:
    """
    ...
    try:
        ...
        # Extract text from the first 35 pages (or fewer if the document is shorter)
